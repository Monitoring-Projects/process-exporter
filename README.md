...
[release]: https://github.com/Monitoring-Projects/process-exporter/releases/latest

[![Release](https://img.shields.io/github/release/Monitoring-Projects/process-exporter.svg?style=flat-square")][release]
...
![Build](https://github.com/Monitoring-Projects/process-exporter/actions/workflows/build.yml/badge.svg)
...
install via [docker](ghcr.io/monitoring-projects/process-exporter).
